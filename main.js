...
function fetchIssues() {
  ...
  for (var i = 0; i < issues.length; i++) {
    ...
    issuesList.innerHTML += '<div class="well">' +
                            ...
                            '<h3>' + desc + '</h3>' +
                            '<p> <span class="glyphicon glyohicon-time"></span>' + severity +
                            '</p>' +
                            '<p> <span class="glyphicon glyohicon-user"> </span>' + assignedTo +
                            '</p>' +
                            '<a href="#" onclick="setStatusClosed(\'' + id +
                            '\')" class="btn btn-warning"> Close </a>' +
                            '<a href="#" onclick="deleteIssue(\'' + id +
